                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                          ...
                          <div class="card-title-right f-b" v-if="statistic && $route.fullPath.includes('usersAll')">Сумма списаний <span :class="{'style-green': statistic.informationStatus, 'style-red': !statistic.informationStatus}">{{ statistic.billingAmount.toFixed(2) }}</span> руб. &nbsp &nbsp Баланс <span :class="{'style-green': statistic.informationStatus, 'style-red': !statistic.informationStatus}">{{ statistic.billingBalance.toFixed(2) }}</span> руб. &nbsp &nbsp Долг <span :class="{'style-green': statistic.informationStatus, 'style-red': !statistic.informationStatus}">{{ statistic.billingCredit.toFixed(2) }}</span> руб.</div>
