    ...
    var myChart = new Chart( ctx, {
        ...
        data: {
            ...
            datasets: [ {
                data: [ 0, 7, 3, 5, 2, 10, 7 ],
                label: "Продаж",
                backgroundColor: 'rgba(0,218,191,.15)',
                borderColor: 'rgba(0,218,191,0.5)',
                borderWidth: 3.5,
                pointStyle: 'circle',
                pointRadius: 5,
                pointBorderColor: 'transparent',
                pointBackgroundColor: 'rgba(0,218,191)',
                    }, ]
        },
        options: {
            responsive: true,
    ...
    var myChart = new Chart( ctx, {
        ...
        data: {
            ...
            datasets: [ {
                ...
                backgroundColor: 'rgba(0,218,191,.15)',
                borderColor: 'rgba(0,218,191,0.75)',
                borderWidth: 3,
                pointStyle: 'circle',
                pointRadius: 5,
                pointBorderColor: 'transparent',
                pointBackgroundColor: 'rgba(0,218,191,0.75)',
                    }
                    ]
        },
        options: {
